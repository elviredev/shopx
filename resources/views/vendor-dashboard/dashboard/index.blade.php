    ...
    @if(auth('web')->user()->kyc?->status == 'pending')
      <div class="alert alert-important alert-warning alert-dismissible" role="alert">
        ...
        <div>
          ...
          <div class="alert-description">Please wait for the admin to approuve your KYC.</div>
        </div>
    ...
    @if(auth('web')->user()->kyc?->status == 'rejected' || auth('web')->user()->kyc?->status == null)
      <div class="alert alert-important alert-danger alert-dismissible" role="alert">
        ...
        <div class="w-100">
          ...
          <div class="alert-description d-flex align-items-center justify-content-between">
            <span>Please submit your KYC verification to get started.</span>
            <div>
