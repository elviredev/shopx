...
@section('contents')
  <div class="container-xl">
    <div class="card">
      ...
      <div class="card-body">
        <form id="roleForm" action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="mb-3">
                ...
                <x-input-image class="ms-0" imagePreviewId="image-preview" imageUploadId="image-upload" imageLabelId="image-label" name="brand_logo" />
